...
var Complex = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "complexe-container" },
        react_1["default"].createElement("div", { className: "title", dangerouslySetInnerHTML: {
                __html: data.titre
            } }),
        react_1["default"].createElement("div", { className: "complexe" },
            ...
            data.photo && (react_1["default"].createElement("div", { className: "illustration" },
                react_1["default"].createElement("img", { src: (_b = data.photo) === null || _b === void 0 ? void 0 : _b.node.sourceUrl, alt: (_c = data.photo) === null || _c === void 0 ? void 0 : _c.node.altText }),
