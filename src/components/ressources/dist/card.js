    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, slug ? (react_1["default"].createElement(gatsby_1.Link, { to: "/" + lang + "/" + slug },
        react_1["default"].createElement("div", { className: "card" },
            ...
            react_1["default"].createElement("div", { className: "content-container" },
                type == "ressource" && (react_1["default"].createElement("p", { className: "date" }, new Date(date).toLocaleDateString(lang, {
                    day: "numeric",
                    month: "long",
                    year: "numeric"
                }))),
                tags && time && (react_1["default"].createElement("div", { className: "tags" },
                    tags && (react_1["default"].createElement("div", null, tags.nodes.map(function (tag, index) { return (react_1["default"].createElement("p", { className: "tag", key: index }, tag.name)); }))),
        ...
        react_1["default"].createElement("div", { className: "card" },
            ...
            react_1["default"].createElement("div", { className: "content-container" },
                ...
                tags && time && (react_1["default"].createElement("div", { className: "tags" },
                    tags &&
                        tags.map(function (tag, index) { return (react_1["default"].createElement("p", { className: "tag", key: index }, tag.name)); }),
                    !tags && react_1["default"].createElement(react_1["default"].Fragment, null),
                    time && (react_1["default"].createElement("p", { className: "time" },
                        time,
                        " MIN")))),
